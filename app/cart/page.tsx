    ...
    <div className="flex flex-1 flex-col justify-between">
      <div>
        ...
        <p className="mt-2 text-sm font-medium text-[#806e68]">
          ${item.price.toFixed(2)} <span className="text-xs font-normal">each</span>
        </p>
      </div>
      ...
      <div className="mt-4 flex flex-wrap items-center gap-6">
        ...
        <div className="flex items-center rounded-full border border-[#d8c4bd] bg-[#fcf9f6] cursor-pointer">
          ...
          <button
            type="button"
            onClick={() => updateQuantity(item.id, item.quantity + 1)}
            className="flex h-9 w-9 items-center justify-center text-[#806e68] transition hover:text-[#b65f67]"
          >
